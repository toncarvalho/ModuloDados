...
- Figuras das heroínas geradas com **[DiceBear](https://www.dicebear.com/)**, estilo
  **[Lorelei](https://www.dicebear.com/styles/lorelei/)** por Lisa Wischofsky — licença
  **CC0 1.0** (domínio público). Geradas no momento do desenvolvimento e embutidas como SVG;
  o jogo não depende do DiceBear em runtime.
