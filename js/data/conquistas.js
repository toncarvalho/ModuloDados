...
const CONQUISTAS = [
  ...
  { id: "meio", icone: "⭐", nome: "Meio caminho", desc: "Junte 18 estrelas", recompensa: 30,
    cond: (s) => s.totalEstrelas >= 18 },
  { id: "ouro", icone: "🌟", nome: "Tudo dourado", desc: "Junte 36 estrelas", recompensa: 100,
    cond: (s) => s.totalEstrelas >= 36 },
